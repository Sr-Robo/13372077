...
export default function EveryWhere() {
    return (React.createElement("div", { className: "container mx-auto px-4 py-8 bg-gray-100 rounded-lg shadow-md mt-10" },
        React.createElement("h1", { className: "font-bold text-center mb-6" }, "Everywhere"),
        React.createElement("p", { className: "text-gray-700 text-center" }, "This component is rendered on every page of the store front."),
