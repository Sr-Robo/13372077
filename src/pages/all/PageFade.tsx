...
function isInternalNavigationClick(event: MouseEvent, anchor: HTMLAnchorElement) {
...
export default function PageFade() {
  ...
  useEffect(() => {
    ...
    const handleClick = (event: MouseEvent) => {
      ...
      if (!anchor || !isInternalNavigationClick(event, anchor)) return;
  ...
  return <div ref={overlayRef} className="cpk-fade" aria-hidden="true" />;
}
