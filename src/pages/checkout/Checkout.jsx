...
const Title = () => {
  return (
    <div className="checkout-header mb-8 text-center">
      <h1
        className="checkout-title cpk-h1 tracking-tight"
...
export default function CheckoutPage({
  ...
  return (
    ...
    >
      <Title />
      <MobileOrderSummary />
      <div className="page-width col2-set cpl-checkout-wrap grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-8 pb-16" id="customer_details">
        <div className="col-1">
        ...
        <div className="col-2 cpl-woocommerce-checkout-order-col hidden h-fit space-y-6 lg:sticky lg:top-8 lg:block">
          {showShippingNote && <ShippingNote />}
          <div className="cpk-order-summary">
            <h2 className="cpk-h4 summary-title">{_('Order summary')}</h2>
            <OrderSummaryContent />
          </div>
        </div>
      </div>
